...
input_yaml_multiple(config_file, key1 = "model_parameters", key2 = "GLM", key3 = "bsn_len_outl", get_nml_value(nml, "bsn_len_outl"))
input_yaml_multiple(config_file, key1 = "model_parameters", key2 = "GLM", key3 = "bsn_wid", get_nml_value(nml, "bsn_wid"))
input_yaml_multiple(config_file, key1 = "model_parameters", key2 = "GLM", key3 = "bsn_wid_outl", get_nml_value(nml, "bsn_wid_outl"))
input_yaml_multiple(config_file, key1 = "model_parameters", key2 = "GLM", key3 = "coef_mix_shear", get_nml_value(nml, "coef_mix_shear"))
input_yaml_multiple(config_file, key1 = "model_parameters", key2 = "GLM", key3 = "coef_mix_shear", get_nml_value(nml, "coef_mix_shear"))
input_yaml_multiple(config_file, key1 = "model_parameters", key2 = "GLM", key3 = "coef_mix_hyp", get_nml_value(nml, "coef_mix_hyp"))
